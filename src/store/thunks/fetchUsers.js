//! Note:
// The goal of "fetchUsers" thunk is to fetch some data and automatically have some actions dispatched for us as we are 
// fetching the data.
...
// 6- When user does something, dispatch the thunk function to run it //* inside "UsersList" component
